...
public class EmojiParser {
    ...
    private HashMap<String,Integer> utfEmoMap = new HashMap<>();
                        ...
                        case XmlPullParser.START_TAG: {
                            ...
                            if (xmlpull.getName().equals("e")) {
                                ...
                                if (fromAttr.length() > 6) {
                                    ...
                                    utfemojiKey = "["+fromAttr+"]";
                                    utfemojiValue = Integer.parseInt(fromAttr, 16);

                                }
                                convertMap.put(fromCodePoints, fromAttr);

                                utfEmoMap.put(utfemojiKey,utfemojiValue);
                            }
                            break;
                        }
